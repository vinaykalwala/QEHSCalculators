...
{"name": "Energy Balance between Steam and Secondary Fluid of a Non-Flow Process calculator", "url_name": "environment_energy_balance_between_steam_and_secondary_fluid_of_a_non_flow_process_calculator", "plan_type": "corporate", "category": "environment"},
...
{"name": "Mean Steam Consumption  Of a Flow-Type Application calculator (2)", "url_name": "environment_mean_steam_consumption_of_a_flow_type_application2_calculator", "plan_type": "corporate", "category": "environment"},
...
{"name": "Steam Condensing Rate for Air Heating Equipment calculator", "url_name": "environment_steam_condensing_rate_for_air_heating_equipment_calculator", "plan_type": "corporate", "category": "environment"},
...
{"name": "Water Consumption per Employee Calculator", "url_name": "environment_water_consumption_per_employee_calculator", "plan_type": "corporate", "category": "environment"},
    # Health Calculators
   {"name": "Army Body Fat Calculator", "url_name": "health_army_body_fat_calculator", "plan_type": "individual", "category": "health"},
{"name": "Adjusted Body Weight Calculator", "url_name": "health_adjusted_body_weight_calculator", "plan_type": "individual", "category": "health"},
{"name": "A Body Shape Index (ABSI) Calculator", "url_name": "health_a_body_shape_index_absi_calculator", "plan_type": "individual", "category": "health"},
{"name": "A1c Calculator", "url_name": "health_a1c_hemoglobin_a1c_to_average_blood_sugar_calculator", "plan_type": "individual", "category": "health"},
{"name": "Age Shock Index (Age SI) Calculator", "url_name": "health_age_shock_index_age_si_calculator", "plan_type": "individual", "category": "health"},
{"name": "Alzheimer’s Life Expectancy Calculator", "url_name": "health_alzheimers_life_expectancy_calculator", "plan_type": "individual", "category": "health"},
{"name": "Ankle-Brachial Index (ABI) Calculator", "url_name": "health_ankle_brachial_index_abi_calculator", "plan_type": "individual", "category": "health"},
{"name": "BMI Calculator", "url_name": "health_bmi_calculator", "plan_type": "individual", "category": "health"},
{"name": "BMI Calculator for Kids", "url_name": "health_bmi_for_kids_calculator", "plan_type": "employee", "category": "health"},

{"name": "Basal Metabolic Rate (BMR) Calculator", "url_name": "health_basal_metabolic_rate_bmr_calculator", "plan_type": "employee", "category": "health"},
{"name": "Body Roundness Index (BRI) Calculator", "url_name": "health_body_roundness_index_bri_calculator", "plan_type": "employee", "category": "health"},
{"name": "Body Fat Calculator (U.S. Navy Method)", "url_name": "health_body_fat_us_navy_method_calculator", "plan_type": "employee", "category": "health"},
{"name": "Body Adiposity Index (BAI) Calculator", "url_name": "health_body_adiposity_index_bai_calculator", "plan_type": "employee", "category": "health"},
{"name": "Body Frame Size Calculator", "url_name": "health_body_frame_size_calculator", "plan_type": "employee", "category": "health"},
{"name": "Body Surface Area (BSA) Calculator", "url_name": "health_body_surface_area_bsa_calculator", "plan_type": "employee", "category": "health"},
{"name": "Blood Sugar Converter", "url_name": "health_blood_sugar_converter_calculator", "plan_type": "employee", "category": "health"},
{"name": "Bedridden Patient Height Estimator", "url_name": "health_bedridden_patient_height_estimator_calculator", "plan_type": "employee", "category": "health"},

{"name": "Bedridden Patient Weight Estimator", "url_name": "health_bedridden_patient_weight_estimator_calculator", "plan_type": "employee", "category": "health"},
{"name": "Baby Milk Intake Calculator", "url_name": "health_baby_milk_intake_calculator", "plan_type": "employee", "category": "health"},
{"name": "Cardiac Index Calculator", "url_name": "health_cardiac_index_calculator", "plan_type": "employee", "category": "health"},
{"name": "Cholesterol Units Converter", "url_name": "health_cholesterolunitsconverter", "plan_type": "employee", "category": "health"},
{"name": "Daily Drinking Water Intake Calculator", "url_name": "health_daily_drinking_water_intake_calculator", "plan_type": "employee", "category": "health"},
{"name": "Dietary Reference Intake (DRI) Calculator", "url_name": "health_dietary_reference_intake_dri_calculator", "plan_type": "employee", "category": "health"},

{"name": "Diabetes Risk Calculator", "url_name": "health_diabetes_risk_estimate_your_75_year_risk_calculator", "plan_type": "employee", "category": "health"},
{"name": "Depression Screening (PHQ-2) Calculator", "url_name": "health_depression_screening_by_phq_2_calculator", "plan_type": "employee", "category": "health"},
{"name": "Dose-Response Probit Calculator", "url_name": "health_dose_response_probit_calculator", "plan_type": "employee", "category": "health"},
{"name": "Diet Risk Score Calculator", "url_name": "health_diet_risk_score_calculator", "plan_type": "employee", "category": "health"},
{"name": "Estimated Average Glucose (eAG) Calculator", "url_name": "health_estimated_average_glucose_calculator", "plan_type": "employee", "category": "health"},
{"name": "Epworth Sleepiness Scale (ESS) Calculator", "url_name": "health_epworth_sleepiness_scale_ess_calculator", "plan_type": "employee", "category": "health"},
...
{"name": "Steam Consumption By Injection Into A Tank Calculator", "url_name":"safety_steam_consumption_by_injection_into_a_tank_calculator", "plan_type": "corporate", "category": "safety"},
...
{"name": "2:1 Ellipsoidal Head Radius Calculator", "url_name":"safety_21_ellipsoidal_head_radius_calculator", "plan_type": "corporate", "category": "safety"},
    ...
    {"name": "Design Quantity Of Co2 Calculator For local applications", "url_name": "fire_discharge_rate_of_co2_for_local_applications_calculator", "plan_type": "employee", "category": "fire"},
    {"name": "Equivalent Orifice Area Calculator For Co2", "url_name": "fire_equivalent_orifice_area_for_co2_calculator", "plan_type": "employee", "category": "fire"},
       {"name": "Equivalent Water Flowrate Through A Check Valve Calculator", "url_name": "fire_equivalent_water_flowrate_through_a_check_valve_calculator", "plan_type": "employee", "category": "fire"},
    {"name": "Fire Load Calculator", "url_name": "fire_fire_load_calculator", "plan_type": "employee", "category": "fire"},
    
     {"name": "Fire Extinguisher Placement Calculator", "url_name": "fire_fire_extinguisher_placement_calculator", "plan_type": "employee", "category": "fire"},
    {"name": "Fire Extinguisher Weight Inspection Calculator", "url_name": "fire_fire_extinguisher_weight_inspection_calculator", "plan_type": "employee", "category": "fire"},
    {"name": "fire Load Density Calculator", "url_name": "fire_fire_load_density_calculator", "plan_type": "employee", "category": "fire"},
    {"name": "Fire Flow calcualtor", "url_name": "fire_fire_flow_calculator", "plan_type": "employee", "category": "fire"},
    {"name": "FM-200 / NOVEC 1230 - Net Hazard Volume Calculator", "url_name": "fire_fm_200_novec_1230_net_hazard_volume_calculator", "plan_type": "employee", "category": "fire"},\
    {"name": "FM-200 / NOVEC 1230 - agent quantity calculator", "url_name": "fire_fm_200_novec_1230_agent_quantity_calculator", "plan_type": "employee", "category": "fire"},
    {"name": "FM-200 / NOVEC 1230 - Nozzle Quantity Calculator", "url_name": "fire_fm_200_novec_1230_nozzle_quantity_calculator", "plan_type": "employee", "category": "fire"},
    {"name": "FM-200 / NOVEC 1230 - Pipe Sizing Calculator", "url_name": "fire_fm_200_novec_1230_pipe_sizing_calculator", "plan_type": "employee", "category": "fire"},
    {"name": "Final design Quantity for co2 calcualtor", "url_name": "fire_final_design_quantity_for_co2_calculator", "plan_type": "employee", "category": "fire"},
    {"name": "Flow rate calculator for Local application System", "url_name": "fire_flow_rate_for_local_application_system_calculator", "plan_type": "employee", "category": "fire"},

    {"name": "Fire Alarm System Secondary Battery -Set Calculation", "url_name": "fire_fire_alarm_system_secondary_battery_set_calculation_calculator", "plan_type": "employee", "category": "fire"},
    {"name": "Fire Safety Occupancy Calculator For Assembly and Recreation Limit", "url_name": "fire_fire_safety_occupancy_for_assembly_and_recreation_limit_calculator", "plan_type": "employee", "category": "fire"},
    {"name": "Flammable Range Calculator", "url_name": "fire_flammable_range_calculator", "plan_type": "employee", "category": "fire"},
    {"name": "Flammability Calculator for Gas Mixtures", "url_name": "fire_flammability_for_gas_mixtures_calculator", "plan_type": "employee", "category": "fire"},
    {"name": "Fauske's Vent Area Calculator", "url_name": "fire_fauskes_vent_area_calculator", "plan_type": "employee", "category": "fire"},
    {"name": "Fire Fighting Demand Calculator", "url_name": "fire_fire_fighting_demand_calculator", "plan_type": "employee", "category": "fire"},
